...
data_root = '/n/pfister_lab2/Lab/vcg_natural/YouTube-VIS/'
img_norm_cfg = dict(
...
log_level = 'INFO'
work_dir = './work_dirs/masktrack_rcnn_r50_fpn_1x_youtubevos_objprop'
load_from = '/n/pfister_lab2/Lab/wdjang/2021_CVPR_VIS/MaskTrackRCNN/epoch_12.pth'
resume_from = None
workflow = [('train', 1)]
